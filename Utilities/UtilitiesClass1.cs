...
namespace ModManager.Mewgenics.Utilities;

public class UtilitiesClass1
{
    private readonly List<strinusing Microsoft.Xna.Framework;
...
g> _items = new();
    ...
    public string Name { get; } = "UtilitiesClass1";
